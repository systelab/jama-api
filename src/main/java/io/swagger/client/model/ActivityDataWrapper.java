...
public class ActivityDataWrapper {
  ...
  public ActivityDataWrapper data(Activity data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ActivityDataWrapper links(Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public ActivityDataWrapper putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ActivityDataWrapper linked(Map<String, Map<String, Object>> linked) {
    this.linked = linked;
    return this;
  }

  public ActivityDataWrapper putLinkedItem(String key, Map<String, Object> linkedItem) {
    if (this.linked == null) {
  ...
  **/
  ...
  public ActivityDataWrapper meta(MetaWrapper meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ActivityDataWrapper activityDataWrapper = (ActivityDataWrapper) o;
    return Objects.equals(this.data, activityDataWrapper.data) &&
        Objects.equals(this.links, activityDataWrapper.links) &&
        Objects.equals(this.linked, activityDataWrapper.linked) &&
        Objects.equals(this.meta, activityDataWrapper.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActivityDataWrapper {\n");
