...
public class TagDataWrapper {
  ...
  public TagDataWrapper data(Tag data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public TagDataWrapper links(Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public TagDataWrapper putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public TagDataWrapper linked(Map<String, Map<String, Object>> linked) {
    this.linked = linked;
    return this;
  }

  public TagDataWrapper putLinkedItem(String key, Map<String, Object> linkedItem) {
    if (this.linked == null) {
  ...
  **/
  ...
  public TagDataWrapper meta(MetaWrapper meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TagDataWrapper tagDataWrapper = (TagDataWrapper) o;
    return Objects.equals(this.data, tagDataWrapper.data) &&
        Objects.equals(this.links, tagDataWrapper.links) &&
        Objects.equals(this.linked, tagDataWrapper.linked) &&
        Objects.equals(this.meta, tagDataWrapper.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class TagDataWrapper {\n");
