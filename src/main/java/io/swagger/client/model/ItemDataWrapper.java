...
public class ItemDataWrapper {
  ...
  public ItemDataWrapper data(Item data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ItemDataWrapper links(Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public ItemDataWrapper putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public ItemDataWrapper linked(Map<String, Map<String, Object>> linked) {
    this.linked = linked;
    return this;
  }

  public ItemDataWrapper putLinkedItem(String key, Map<String, Object> linkedItem) {
    if (this.linked == null) {
  ...
  **/
  ...
  public ItemDataWrapper meta(MetaWrapper meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ItemDataWrapper itemDataWrapper = (ItemDataWrapper) o;
    return Objects.equals(this.data, itemDataWrapper.data) &&
        Objects.equals(this.links, itemDataWrapper.links) &&
        Objects.equals(this.linked, itemDataWrapper.linked) &&
        Objects.equals(this.meta, itemDataWrapper.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemDataWrapper {\n");
