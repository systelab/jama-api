...
public class FilterDataWrapper {
  ...
  public FilterDataWrapper data(Filter data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public FilterDataWrapper links(Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public FilterDataWrapper putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public FilterDataWrapper linked(Map<String, Map<String, Object>> linked) {
    this.linked = linked;
    return this;
  }

  public FilterDataWrapper putLinkedItem(String key, Map<String, Object> linkedItem) {
    if (this.linked == null) {
  ...
  **/
  ...
  public FilterDataWrapper meta(MetaWrapper meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FilterDataWrapper filterDataWrapper = (FilterDataWrapper) o;
    return Objects.equals(this.data, filterDataWrapper.data) &&
        Objects.equals(this.links, filterDataWrapper.links) &&
        Objects.equals(this.linked, filterDataWrapper.linked) &&
        Objects.equals(this.meta, filterDataWrapper.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilterDataWrapper {\n");
