...
public class VersionDataWrapper {
  ...
  public VersionDataWrapper data(Version data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public VersionDataWrapper links(Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public VersionDataWrapper putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public VersionDataWrapper linked(Map<String, Map<String, Object>> linked) {
    this.linked = linked;
    return this;
  }

  public VersionDataWrapper putLinkedItem(String key, Map<String, Object> linkedItem) {
    if (this.linked == null) {
  ...
  **/
  ...
  public VersionDataWrapper meta(MetaWrapper meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VersionDataWrapper versionDataWrapper = (VersionDataWrapper) o;
    return Objects.equals(this.data, versionDataWrapper.data) &&
        Objects.equals(this.links, versionDataWrapper.links) &&
        Objects.equals(this.linked, versionDataWrapper.linked) &&
        Objects.equals(this.meta, versionDataWrapper.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class VersionDataWrapper {\n");
