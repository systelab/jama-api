...
public class AttachmentDataWrapper {
  ...
  public AttachmentDataWrapper data(Attachment data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public AttachmentDataWrapper links(Map<String, Link> links) {
    this.links = links;
    return this;
  }

  public AttachmentDataWrapper putLinksItem(String key, Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public AttachmentDataWrapper linked(Map<String, Map<String, Object>> linked) {
    this.linked = linked;
    return this;
  }

  public AttachmentDataWrapper putLinkedItem(String key, Map<String, Object> linkedItem) {
    if (this.linked == null) {
  ...
  **/
  ...
  public AttachmentDataWrapper meta(MetaWrapper meta) {
    this.meta = meta;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AttachmentDataWrapper attachmentDataWrapper = (AttachmentDataWrapper) o;
    return Objects.equals(this.data, attachmentDataWrapper.data) &&
        Objects.equals(this.links, attachmentDataWrapper.links) &&
        Objects.equals(this.linked, attachmentDataWrapper.linked) &&
        Objects.equals(this.meta, attachmentDataWrapper.meta);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttachmentDataWrapper {\n");
